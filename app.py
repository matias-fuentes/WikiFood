...
def recipes():
    ...
    if request.method == "POST":
        ...
        return saveArticle(cursor, username, 'R', conn)
...
def products():
    ...
    if request.method == "POST":
        ...
        return saveArticle(cursor, username, 'P', conn)
...
def menuItems():
    ...
    if request.method == "POST":
        ...
        return saveArticle(cursor, username, 'M', conn)
...
def login():
    ...
    if request.method == "POST":
        ...
        if '@' in user:
            ...
            return userOrEmail(True, user, password, passRegEx, session, cursor, conn)
        ...
        return userOrEmail(False, user, password, passRegEx, session, cursor, conn)
...
def profile():
    ...
    if request.method == "POST":
        ...
        if profilePic or bannerPic:
            return uploadImage(cursor, profilePic, bannerPic, username, conn, logIn)
