...
def userOrEmail(email, user, password, passRegEx, session, cursor, conn):
...
def saveArticle(cursor, username, articleType, conn):
...
def uploadImage(cursor, profilePic, bannerPic, username, conn, logIn):
    config = {
